...
The  [website](https://shilinhe.github.io/conferences/) contains conferences of three categories currently, i.e., Software Engineering(SE), Artificial Intelligence(AI), and Programming Language(PL)
